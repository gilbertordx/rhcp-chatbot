...
class ModelEvaluator:
    ...
    def generate_evaluation_report(
        self, pipeline, X_test, y_test, test_results, cv_results
    ):
        """
    ...
    def _generate_model_analysis(
        self, pipeline, test_results, cv_results, results_path
    ):
    ...
    def _generate_recommendations(self, test_results, cv_results):
        ...
        problematic_classes = [
            cls for cls, metrics in class_metrics.items() if metrics["f1_score"] < 0.3
        ]
